def unique_houses(filename):
    ...
    houses = set()
    # test_line = "Corey|Shott|Hufflepuff|Heather|Summer 2015"
    with open(filename) as in_file:
        for line in in_file:
            split_line = line.split('|')
            # split_line = test_line.split('|')
            # If they are an instructor or TA
            if (split_line[-1] == 'TA' or split_line[-1] == 'I'):
                # print "Staff should be: ", split_line[-1]
                pass
            else:
                # print "Should be student: ", split_line[-1]
                if not split_line[2] == '':
...
def sort_by_cohort(filename):
    ...
    """
    # Sadie|Wilhelm|Ravenclaw|Joel|Spring 2015
    # Lavinia|Karl|||TA
    persons ="""Lauren|Orencio|Gryffindor|Cynthia|Summer 2015
Lavinia|Karl|||TA
Leslie|Castellanos|||TA
Lindsay|Grizzard|Dumbledore's Army|Lindsay|Spring 2015
Lindsey|Simard|Ravenclaw|Meggie|Winter 2015
Liz|Acosta|Ravenclaw|Heather|Winter 2015
Meggie|Mahnken|||I
"""
    ta = "Leslie|Castellanos|||TA"
    all_students = []
    winter_15 = []
    spring_15 = []
    summer_15 = []
    ...
    with open(filename) as people:
        ...
        #for person in persons:
            # Split person
            first_name, last_name, house, advisor, cohort = person.split('|')

            #first_name, last_name, house, advisor, cohort = ta.split('|')
            name = first_name + " " + last_name

            # Sort person
            # If the person is a TA
            if (cohort == 'TA'):
                print "TA:\t" , name
                print person
                tas.append(name)
